...
$.fn.dataTable=function(oInit){function classSettings(){this.fnRecordsTotal=function(){if(this.oFeatures.bServerSide){return this._iRecordsTotal
			...
			this.oLanguage = {
				...
				sInfo : "Mostrando desde _START_ hasta _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando desde 0 hasta 0 de 0 entradas",sInfoFiltered:"(Se filtro de un total de _MAX_ registros)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Inicio",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Final"}};
