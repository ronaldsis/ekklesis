...
<body>
  <div id="main-panel">
    <div class="ae-widget-sidebar minimizable">
      <h4 class="ae-widget-header">Registrar Estado</h4>
      <div class="ae-widget-content">
        <div id="create-estado"
          ...
          <fieldset class="buttons">
              <g:jasperReport jasper="Estados.jrxml" format="PDF,XLS" name="Estados" action="reporte" controller="estado" />
            </fieldset>
          
          <g:jasperReport jasper="sample-jasper-plugin.jrxml" format="PDF" name="Estados 2" />
          <g:jasperReport jasper="Estados.jrxml" format="PDF" name="Estados 3" />
