	...
	<div id="main-panel">
		<div class="ae-widget-sidebar minimizable">
			<h4 class="ae-widget-header">
                          Editar Relaci&oacute;n Rol-Grupo
			</h4>
			<div class="ae-widget-content">
				<div id="edit-rolGrupo"
					class="content scaffold-edit" role="main">
					<g:if test="${flash.message}">
						<div class="message" role="status">${flash.message}</div>
					</g:if>
					<g:hasErrors bean="${rolGrupoInstance}">
						<div class="error" role="alert">
							<g:eachError bean="${rolGrupoInstance}" var="error">
					...
					<g:form method="post"
						>
						<g:hiddenField name="id" value="${rolGrupoInstance?.id}" />
						<g:hiddenField name="version" value="${rolGrupoInstance?.version}" />
						<fieldset class="form">
