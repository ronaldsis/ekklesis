  ...
  <div id="main-panel">
    <div class="ae-widget-sidebar minimizable">
      <h4 class="ae-widget-header">
        Editar
        Relaci&oacute;n Persona Reuni&oacute;n
      </h4>
      <div class="ae-widget-content">
        <div id="edit-reunionPersona"
             class="content scaffold-edit" role="main">
          <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
          </g:if>
          <g:hasErrors bean="${reunionPersonaInstance}">
            <div class="error" role="alert">
              <g:eachError bean="${reunionPersonaInstance}" var="error">
          ...
          <g:form method="post"
                  >
            <g:hiddenField name="id" value="${reunionPersonaInstance?.id}" />
            <g:hiddenField name="version" value="${reunionPersonaInstance?.version}" />
            <fieldset class="form">
