	...
	<div id="main-panel">
		<div class="ae-widget-sidebar minimizable">
			...
			<div class="ae-widget-content">
				<div id="edit-clasificacionPersona"
					class="content scaffold-edit" role="main">
					<g:if test="${flash.message}">
						<div class="message" role="status">${flash.message}</div>
					</g:if>
					<g:hasErrors bean="${clasificacionPersonaInstance}">
						<div class="error" role="alert">
							<g:eachError bean="${clasificacionPersonaInstance}" var="error">
					...
					<g:form method="post"
						>
						<g:hiddenField name="id" value="${clasificacionPersonaInstance?.id}" />
						<g:hiddenField name="version" value="${clasificacionPersonaInstance?.version}" />
						<fieldset class="form">
